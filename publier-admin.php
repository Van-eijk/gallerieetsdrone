        ...
        <body>
            <div class="container">
                ...
                <div class="formulaire">
                    ...
                    <form action="publier-admin-data.php" method="post" enctype="multipart/form-data">


                        <select name="categoriePublication" class="form-select mb-3" aria-label="Default select example">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="titrePublication" id="floatingInput" placeholder="Titre publication">
                            <label for="floatingInput">Titre publication</label>
                        </div>

                        <div class="form-floating mb-3">
                            <textarea class="form-control" name="descriptionPublication" placeholder="Description de l'article " id="floatingTextarea"></textarea>
                            <label for="floatingTextarea">Description</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="auteurPublication" id="floatingInput" placeholder="Auteur de l'article">
                            <label for="floatingInput">Auteur de l'article</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" name="prixPublication" id="floatingPassword" placeholder="Prix">
                            <label for="floatingPassword">Prix</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="file" name="imagePublication[]" class="form-control" id="floatingInput" placeholder="Image de l'article" multiple>
                        ...
                        <button type="submit" name="publier" class="btn btn-primary">Submit</button>
